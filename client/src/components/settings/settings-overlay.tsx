...
function TemplateSettings() {
  const [repoUrl, setRepoUrl] = useState("https://github.com/Gurkirat-Singh-bit/Get-that-quick-prompt-templates");
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] text-zinc-600 mt-0.5">Guides, API reference, and deployment docs</p>
            </div>
            <ExternalLink className="w-3 h-3 text-zinc-600" />
          </a>
        </div>
